...
app.post("/risks", async (req, res) => {
  ...
  const values = [
    ...
    data.jenis_risiko,
    data.skenario_risiko,
    data.root_cause,
    data.dampak,
    data.dampak_keuangan,
    data.tingkat_dampak_keuangan,
    data.dampak_operasional,
    data.tingkat_dampak_operasional,
    data.dampak_reputasi,
    data.tingkat_dampak_reputasi,
    data.dampak_regulasi,
    data.tingkat_dampak_regulasi,
    data.skor_kemungkinan,
    data.tingkat_kemungkinan,
    data.nilai_risiko,
    data.tingkat_risiko,
    data.rencana_penanganan,
    data.deskripsi_rencana_penanganan,
    data.risiko_residual,
    data.kriteria_penerimaan_risiko,
    data.pemilik_risiko,
  ...
  try {
    const [rows] = await db.query(`
      SELECT 
        ...
        u.id AS unit_id,
        u.unit_name,
        u.unit_type AS tipe,   -- alias agar sinkron
        u.parent_id
      FROM rcsa_master m
