...
export default function RiskRegisterPage() {
  ...
  const userDivisionMap = Object.fromEntries(users.map(u => [u.id, u.unit_name]));
  ...
  return (
    <>
      <div className='py-4 px-4'>
        <PageHeader title="RISK REGISTER" description={`Total Risk Event / Potensi Risiko: ${selectedDivision}.`}>
