...
//   tingkat_dampak_keuangan: z
//     .string()
//     .min(1, "Tingkat dampak keuangan wajib diisi."),
//   dampak_operasional: z
//     .number()
//     .min(0, "Dampak operasional harus berupa angka."),
//   tingkat_dampak_operasional: z
//     .string()
//     .min(1, "Tingkat dampak operasional wajib diisi."),
//   dampak_reputasi: z.number().min(0, "Dampak reputasi harus berupa angka."),
//   tingkat_dampak_reputasi: z
//     .string()
//     .min(1, "Tingkat dampak reputasi wajib diisi."),
//   dampak_regulasi: z.number().min(0, "Dampak regulasi harus berupa angka."),
//   tingkat_dampak_regulasi: z
//     .string()
//     .min(1, "Tingkat dampak regulasi wajib diisi."),
...
//   deskripsi_rencana_penanganan: z
//     .string()
//     .min(1, "Deskripsi rencana penanganan wajib diisi."),
//   risiko_residual: z.string().min(1, "Risiko residual wajib diisi."),
//   kriteria_penerimaan_risiko: z
//     .string()
//     .min(1, "Kriteria penerimaan risiko wajib diisi."),
...
//     ? risks.filter(
//         (risk) =>
//           userDivisionMap[risk.pemilik_risiko]?.toString() === selectedDivision
//       )
//     : risks;

//   const divisionTotals = users
//     .map((user) => {
//       const totalRisk = risks.filter(
//         (r) => r.pemilik_risiko === user.id
//       ).length;
//       return { name: user.unit_name, total: totalRisk };
//     })
...
//         <PageHeader
//           title="RISK REGISTER"
//           description={`Total Risk Event / Potensi Risiko: ${selectedDivision}.`}
//         >
...
//                       <FormControl>
//                         <Input
//                           placeholder="e.g., Risiko Teknologi Informasi"
//                           {...field}
//                         />
//                       </FormControl>
//                       <FormMessage />
...
//                       <FormControl>
//                         <Textarea
//                           placeholder="e.g., Penyalahgunaan akses"
//                           {...field}
//                         />
//                       </FormControl>
//                       <FormMessage />
...
//                       <FormControl>
//                         <Textarea
//                           placeholder="e.g., Kerugian finansial"
//                           {...field}
//                         />
//                       </FormControl>
//                       <FormMessage />
...
//                   ] as { key: keyof RiskFormValues; label: string }[]
//                 ).map(({ key, label }) => (
//                   <FormField
//                     key={key}
//                     control={form.control}
...
//                   [
//                     {
//                       key: "tingkat_dampak_keuangan",
//                       label: "Tingkat Dampak Keuangan",
//                     },
//                     {
//                       key: "tingkat_dampak_operasional",
//                       label: "Tingkat Dampak Operasional",
//                     },
//                     {
//                       key: "tingkat_dampak_reputasi",
//                       label: "Tingkat Dampak Reputasi",
//                     },
//                     {
//                       key: "tingkat_dampak_regulasi",
//                       label: "Tingkat Dampak Regulasi",
//                     },
//                     {
...
//                       <FormControl>
//                         <Textarea
//                           placeholder="e.g., Audit internal tambahan"
//                           {...field}
//                         />
//                       </FormControl>
//                       <FormMessage />
...
//                       <FormControl>
//                         <Textarea
//                           placeholder="e.g., Diterima oleh manajemen"
//                           {...field}
//                         />
//                       </FormControl>
//                       <FormMessage />
...
//           </AlertDialogHeader>
//           <AlertDialogFooter>
//             <AlertDialogCancel onClick={() => setDeletingRisk(null)}>
//               Cancel
//             </AlertDialogCancel>
//             <AlertDialogAction
